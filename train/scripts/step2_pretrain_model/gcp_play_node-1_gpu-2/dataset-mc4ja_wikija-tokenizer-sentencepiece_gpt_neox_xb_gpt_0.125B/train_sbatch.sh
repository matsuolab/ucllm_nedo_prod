...
#SBATCH --nodes=1
#SBATCH --job-name=train_gpt_neox_xb
#SBATCH --output=pt_gpt_neox_xb.125B.out
...
directories=(
    "/persistentshare/storage/team_dev_YU/tokenized_data/mc4"
    "/persistentshare/storage/team_dev_YU/tokenized_data/wikipedia_ja"
)
